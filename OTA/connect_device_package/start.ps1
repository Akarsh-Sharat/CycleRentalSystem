...
# & $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a2voxmy6jorank-ats.iot.us-east-1.amazonaws.com --ca_file root-CA.crt --cert OTA_Testing2.cert.pem --key OTA_Testing2.private.key --client_id basicPubSub --topic sdk/test/Python --count 0
& $python3 aws-iot-device-sdk-python-v2\samples\jobs.py --endpoint a2voxmy6jorank-ats.iot.us-east-1.amazonaws.com --ca_file root-CA.crt --cert OTA_Testing2.cert.pem --key OTA_Testing2.private.key --thing_name OTA_Testing2 